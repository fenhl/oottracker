...
scene_flags! {
    pub struct SceneFlags {
        ...
        0x0b: "Gerudo Training Grounds" {
            chests: {
                "Gerudo Training Grounds Heavy Block Third Chest" = 0x0010_0000,
                "Gerudo Training Grounds Lobby Left Chest" = 0x0008_0000,
                "Gerudo Training Grounds Hammer Room Clear Chest" = 0x0004_0000,
                "Gerudo Training Grounds Before Heavy Block Chest" = 0x0002_0000,
                "Gerudo Training Grounds Hammer Room Switch Chest" = 0x0001_0000,
                "Gerudo Training Grounds Heavy Block First Chest" = 0x0000_8000,
                "Gerudo Training Grounds Heavy Block Second Chest" = 0x000_4000,
                "Gerudo Training Grounds Underwater Silver Rupee Chest" = 0x0000_2000,
                "Gerudo Training Grounds Maze Path Final Chest" = 0x0000_1000,
                "Gerudo Training Grounds Hidden Ceiling Chest" = 0x0000_0800,
                "Gerudo Training Grounds Maze Path Second Chest" = 0x0000_0400,
                "Gerudo Training Grounds Maze Path Third Chest" = 0x0000_0200,
                "Gerudo Training Grounds Maze Right Side Chest" = 0x0000_0100,
                "Gerudo Training Grounds Lobby Right Chest" = 0x0000_0080,
                "Gerudo Training Grounds Maze Path First Chest" = 0x0000_0040,
                "Gerudo Training Grounds Maze Right Central Chest" = 0x0000_0020,
                "Gerudo Training Grounds Near Scarecrow Chest" = 0x0000_0010,
                "Gerudo Training Grounds Eye Statue Chest" = 0x0000_0008,
                "Gerudo Training Grounds Heavy Block Fourth Chest" = 0x0000_0004,
                "Gerudo Training Grounds Beamos Chest" = 0x0000_0002,
                "Gerudo Training Grounds Stalfos Chest" = 0x0000_0001,
            },
            switches: {
                0 for "Gerudo Training Grounds Lobby" /*vanilla*/ -> "Gerudo Training Grounds Lava Room" = 0x4000_0000,
            },
            collectible: {
                "Gerudo Training Grounds Freestanding Key" = 0x0000_0002,
            },
        },
        0x0c: ThievesHideout {
